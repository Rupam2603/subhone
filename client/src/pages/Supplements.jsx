  ...
  return (
    <div className="space-y-stack-lg">
      <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant shadow-sm text-center">
        <h1 className="font-headline-lg text-headline-lg text-navy-deep mb-2">Health Supplements</h1>
        <p className="font-body-md text-on-surface-variant">Boost your immunity and overall wellness with top-rated supplements.</p>
        <div className="flex flex-wrap justify-center gap-3 mt-6">
          {['Vitamins', 'Protein & Fitness', 'Immunity', 'Herbal', 'Bone & Joint'].map(cat => (
        ...
        {supplements.map(item => (
          <div key={item.id} className="bg-surface-container-lowest p-4 rounded-xl border border-outline-variant/30 flex flex-col group hover:shadow-md transition-shadow">
             ...
             <div className="flex-grow">
               ...
               <p className="text-[12px] text-on-surface-variant mb-2">{item.brand} • {item.category}</p>
             ...
             <div className="flex items-center justify-between mt-auto">
               ...
               <button 
                 onClick={() => addToCart(item, 'supplement')}
